...
public interface TransferenciaRepository extends JpaRepository<Transferencia, Long> {
    ...
    @Query("SELECT NEW br.com.banco.dto.TransferenciaDTO(t.id, t.dataTransferencia, t.valor, t.tipoTransferencia, t.nomeOperadorTransacao, c.idConta) " +
        "FROM Transferencia t JOIN t.conta c ON c.idConta = :#{#idConta} " +
        "WHERE " +
    ...
    Page<TransferenciaDTO> findByFilter(@Param("filtro") TransferenciaFiltro filtro, Pageable page, Long idConta);
}
